...
public class BoGaCa extends Frame implements ActionListener{
    ...
    Label labelMonAn = new Label("Chọn món ăn:");
    Label labelMonDaChon = new Label("Các món ăn đã chọn:");
    
    CheckboxGroup g = new CheckboxGroup();
    Checkbox radioBo = new Checkbox("Bò",g,true);
    Checkbox radioGa = new Checkbox("Gà",g,false);
    Checkbox radioCa = new Checkbox("Cá",g,false);
    
    Checkbox checkboxNuong = new Checkbox("Nướng");
    Checkbox checkboxLuoc = new Checkbox("Luộc");
    Checkbox checkboxChien = new Checkbox("Chiên");
    ...
    public static void main(String[] args) {
        BoGaCa f = new BoGaCa("Choose button");
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        if(e.getSource()== buttonBoChon)
        {
            ...
            if(i<0)
            {
              javax.swing.JOptionPane.showMessageDialog(this, "Bạn chưa chọn!");
              return;
            }
